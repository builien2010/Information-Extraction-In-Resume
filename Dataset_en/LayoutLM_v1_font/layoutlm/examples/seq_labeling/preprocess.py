...
def actual_bbox_string(box, width, length, font_size, font_name):
    return (
        str(box[0])
        + " "
        + str(box[1])
                ...
                if label == "other":
                    for w in words:
                        ...
                        fiw.write(
                            w["text"]
                            + "\t"
                            + actual_bbox_string(w["box"], width, length, w['size'], w['font'])
                            + "\t"
                            + file_name
                            + "\n"
                        )
                    ...
                    if len(words) == 1:
                        ...
                        fiw.write(
                            words[0]["text"]
                            + "\t"
                            + actual_bbox_string(words[0]["box"], width, length, words[0]['size'], words[0]['font'])
                            + "\t"
                            + file_name
                            + "\n"
                        )
