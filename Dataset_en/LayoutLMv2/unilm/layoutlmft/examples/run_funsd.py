...
def main():
    ...
    print("\n\nLien\n\n")
    print(os.path.abspath(layoutlmft.data.datasets.funsd.__file__))
    ...
    if training_args.do_predict:
        ...
        output_test_true = os.path.join(training_args.output_dir, "test_ground_true.txt")
        if trainer.is_world_process_zero():
            with open(output_test_true, "w") as writer:
